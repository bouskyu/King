...
private:
  ...
  vector<ExecConfig> configs = {
      ...
      ExecConfig("SecureROM for s5l8960xsi, Copyright 2012, Apple Inc.",
                 "RELEASE", "iBoot-1704.10", 0x10000B9A8),
  };
  vector<DevicePlatform> all_platforms = {
      ...
      DevicePlatform(0x8000, 0x20, 0x01, "arm64", "iBoot-2234.0.0.2.22",
                     ...
                     0x180000000, 0x400000, 0x800000000,
                     32, 20, 0x2102BC000),
      DevicePlatform(0x8960, 0x11, 0x01, "arm64", "iBoot-1704.10",
                     0x100000000, 0x20000, "2ae035c46e02ca40ae777f89a6637be694558f0a",
                     0x180000000, 0x400000, 0x800000000,
                     20, 20, 0x20E02A000)
  };
